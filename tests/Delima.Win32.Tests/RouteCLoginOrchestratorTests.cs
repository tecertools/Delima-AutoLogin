...
public class RouteCLoginOrchestratorTests
{
    ...
    [InlineData("Log Masuk dengan akaun DELIMa", true)]
    ...
    [InlineData("Continue with Google", true)]
    [InlineData("Log masuk dengan Google", true)]
    [InlineData("Teruskan dengan Google", true)]
    [InlineData("Sign in with Google", true)]
