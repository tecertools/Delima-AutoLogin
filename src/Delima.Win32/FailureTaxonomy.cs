...
public static class FailureCodes
{
    ...
    private static readonly Dictionary<string, (string Condition, string PupilMessageBm, string TeacherAction)> Taxonomy =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [E14_PasswordRejected] = ("Password rejected by Google (stale credential)", "Kata laluan tidak diterima. Beritahu cikgu.", "Mod Guru for one pupil; re-import in Delima.Admin if the whole class fails")
        };
